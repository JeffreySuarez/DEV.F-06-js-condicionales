...
if (programaEducativo === "carrera" && beca === "facebook") {
  console.log(descuentoCarreraFacebook * duracionCarrera);
} else if (programaEducativo === "carrera" && beca === "google") {
  console.log(descuentoMasterGoogle * duracionCarrera);
} else if (programaEducativo === "carrera" && beca === "jesua") {
  console.log(descuentoCourseJesua * duracionCarrera);
}

if (programaEducativo === "master" && beca === "facebook") {
  console.log(descuentoMasterFacebook * duracionMaster);
} else if (programaEducativo === "master" && beca === "google") {
  console.log(descuentoMasterGoogle * duracionMaster);
} else if (programaEducativo === "master" && beca === "jesua") {
  console.log(descuentoMasterJesua * duracionMaster);
}

if (programaEducativo === "course" && beca === "facebook") {
  console.log(descuentoCourseFacebook * duracionCourse);
} else if (programaEducativo === "course" && beca === "google") {
  console.log(descuentoCourseGoogle * duracionCourse);
} else if (programaEducativo === "course" && beca === "jesua") {
  console.log(descuentoCourseJesua * duracionCourse);
}
